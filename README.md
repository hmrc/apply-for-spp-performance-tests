...
# apply-for-spp-performance-tests
Performance test suite for the `apply-for-statutory-paternity-pay-frontend`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
